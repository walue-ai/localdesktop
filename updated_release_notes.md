## Android PRoot Compatibility Fix - v1.2.14
...
- **Permission ve Cross-Device Link Fix**: Temp file location cache_dir kullanılarak permission denied hatası çözüldü ve extraction destination ile aynı filesystem'de tutularak cross-device link hatası tamamen çözüldü
