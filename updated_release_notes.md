## Android PRoot Compatibility Fix - v1.2.13
...
- **Cross-Device Link Fix**: Temp file location ve extraction destination path'i tamamen aynı filesystem'de (/data/local/tmp/) tutularak cross-device link hatası tamamen çözüldü
